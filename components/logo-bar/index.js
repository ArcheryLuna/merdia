...
const LogoBar = () => {
    ...
    return (
        <div className="fixed visible md:hidden z-[10]">
            <div className="fixed flex items-center top-4 left-4">
                <a href="/"> <img alt="Feeling Stressed" src={LogoSGV} className={classNames(
                    ...
                    'inline-flex text-red-400 h-6 w-34 fancy relative z-[11] text-5xl duration-300 transition-opacity')} />
                    <img alt="Feeling Stressed Full Size" src={LogoNoBG} className={classNames(
                    isVisable ? 'opacity-0' : 'opacity-100',
                    'inline-flex text-red-400 h-6 w-34 fancy text-5xl relative z-[9] duration-300 transition-opacity')} />
