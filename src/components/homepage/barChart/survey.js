...
export default function Survey() {
        ...
        function UpdatedData() {
            if (dataUpdated) {
                return <div>
                    <div class="fixed bottom-1 md:bottom-5 left-5 bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
                        <div class="flex">
                            <div class="py-1"><svg class="fill-current h-6 w-6 text-teal-500 mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zm12.73-1.41A8 8 0 1 0 4.34 4.34a8 8 0 0 0 11.32 11.32zM9 11V9h2v6H9v-4zm0-6h2v2H9V5z"/></svg></div>
                            <div>
                            <p class="font-bold text-left">Thank you</p>
                            <p class="text-sm">Thank you for adding to our data. All data added is annonimous.</p>
                            </div>
                        </div>
                    </div>
                </div> 
        ...
        function sendToApi() {
            ...
            fetch('http://node1.lunacs.co.uk:7321/api/v1/table', requestOptions)
        ...
        return (
            ...
            <UpdatedData />
                    <div className='grid grid-cols-1 md:grid-cols-2 my-12 gap-6 xl:gap-12 px-12'>
                        <div>
                            <h1 className='text-2xl xl:text-3xl px-24 mt-0 md:mt-20'><i className="fa-regular fa-clipboard"/> Would you like to participate in a survey?</h1>
                            <p>Please help us gain more accurate information by participating in the survey. The awnsers you submit are compleatly annonomus.</p>
                        </div>
