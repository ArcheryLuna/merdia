...
export default function Survey() {
        ...
        function UpdatedData() {
            if (dataUpdated) {
                return <div>
                    <div class="fixed z-10 bottom-1 md:bottom-5 left-1 md:left-5 bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
                        <div class="flex">
