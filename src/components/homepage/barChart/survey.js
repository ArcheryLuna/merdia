...
export default function Survey() {
    ...
    const [error, setError] = useState(false)
        ...
        function UpdatedData() {
            if (dataUpdated) {
                return <div>
                    <div className="fixed z-10 bottom-1 right-1 md:right-5 md:bottom-5 left-1 md:left-5 bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 lg:mx-28 shadow-md" role="alert">
                        <div className="flex">
        ...
        function Error() {
            if (error) {
                return <div>
                    <div className="fixed z-10 bottom-1 right-1 md:right-5 md:bottom-5 left-1 md:left-5 bg-red-100 border-t-4 lg:mx-28 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md" role="alert">
                        <div className="flex">
